  ...
  return (
    <>
      <div className='portfolio-content load-animation'>
        ...
        <p className='portfolio-standard-text'>The creation of ths website also contributes towards my portfolio. Here are other examples of my work. Any questions about certain projects feel free to <a href='mailto: rhuntwd@gmail.com' className='links'>contact me</a>.</p>
