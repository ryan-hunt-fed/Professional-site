        ...
        <div className='about-content'>
          <div className='about-text-container'>
            <div className='about-standard-title'>
              ...
              <p className='about-standard-text'>Currently my career interests are for Web Design and Development, to have a mix of a creative focus. I ideally would like to lean more into the design side more than the development but as long as I have some form of design/creativity in my work, that should be enough as one of my main career goals is to have a creative side to it. I&#39;m always eager to learn as I just want to improve my skills generally. As I would like to learn areas of Three.js, WebGL, C# for game development and other code knowledge on my journey, while also improving my CSS and Javascript skills. So any graduate or internship role for this area would be a great help to start out my career in this section of work. As of completing Dev Academy I have been looking for graduate roles and have atteneded events such as Summer of Tech, unfortunatley I have not been given the promised support from these organisations which has been a bit of a hinderance in the job hunting market which is one factor for my longer than like gap between Dev Academy and getting a foot in the door with a dev role. I also have an interest in UX design and while I may only have small certifications in that area, if given the oppertunity, I would be open to any internships or on the job learning for that area as it also has a mix of skills that I have used in the past with my previous jobs. I&#39;m also open to having a mentor in order to improve my UX design skills and other areas I have mentioned. </p>
              <p className='about-standard-text'>My other intentions would be to try to earn a living with my 3D art, which I have studied originally at Yoobee College of Creative Innovation and also in my own time. I will always have a spot in my mind of wanting to work on games, but I know that the games industry is tough in many different ways from experience, even just trying to get my foot in the door I have found it difficult here in New Zealand. However I&#39;m still interested in this area to this day and while I have only had personal expereience, I have not had any work experience in a studio. So for now I&#39;m open to any internships if they are offered to see how a work pipeline works or any entry level positions if training is included. Should things still not work out in that way, I fully intend on trying to make my own designs to sell, wheather they be my own games or my own minature line for a tabletop game which is my current side project for my own IP, that way I know myself that I gave it all my effort. As I have stated previously I just enjoy making different things. I&#39;m looking to improve my skills when I can so I reach a point I&#39;m happy with and I&#39;m up to learning new programs such as ZBrush, Unreal Engine and Substance Painter. Ideally down the road I would like to get involed with character sculpting and 3D printing. For my current 3D portfolio check my <Link to='/Portfolio' className='links'><>portfolio</></Link> page. I unfortunatley have not been able to add to my portfolio due to not having access to Maya but am looking at other possibilities such as the Indie version when I have the disposable income for it or potentially looking at Blender and trying to switch gears to that program.</p>
              <p className='about-standard-text'> For other possible anvenues I&#39;m interested in but do not have the desired training as stated before I would be interested in UX design, Game Delevopment, Motion Designer, Interior Design, Baker/Baking, Digital Marketing and others listed on my home page. For these areas I would be intereseted in any sorts of internships or on the job training if offered. Should these be out of the question I am open to any sort of work oppertunities that are offered my way even if I might be lacking certain skills but I am always eager to learn new skills, as I am open to working in different areas and I am still trying to find that particular route to satisfy what I am after. As I said eariler, I have a list of areas on my <Link to='/' className='links'><>home</></Link> page of areas that I am aware of that I would be interested in possibly pursing more, if given an oppertunity for a chance.</p>
              <br></br>
              ...
              <p className='about-standard-text'>Things I would like to get into at some stage would be learning piano, getting my guitar out again, video editing, photography/astrophotography, astronomy, writing for storytelling, baking, rock climbing, previously mentioned 3D printing, furniture flipping, making different things and archery.</p>
