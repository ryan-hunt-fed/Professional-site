      ...
      <div className='load-animation'>
        ...
        <div className='about-content'>
          <div className='about-standard-title'>
            ...
            <p className='about-standard-text'>My other intentions would be to try to earn a living with my 3D art, which I have studied originally at Yoobee College of Creative Innovation and also in my own time. I will always have a spot in my mind of wanting to work on games, but I know that the games industry is tough in many different ways from experience, even just trying to get my foot in the door I have found it difficult here in New Zealand. However I&#39;m still interested in this area to this day and while I have only had personal expereience, I have not had any work experience in a studio. So for now I&#39;m open to any internships if they are offered to see how a work pipeline works or any entry level positions if training is included. Should things still not work out in that way, I fully intend on trying to make my own designs to sell, wheather they be my own games or my own minature line for a tabletop game. As I have stated previously I just enjoy making different things. I&#39;m looking to improve my skills when I can so I reach a point I&#39;m happy with and I&#39;m up to learning new programs such as zBrush and Substance Painter. Ideally down the road I would like to get involed with character sculpting and 3D printing. For my current 3D portfolio check my <a href='/Portfolio' className='links'>portfolio</a> page</p>
